...
" {{{ Setup
  ...
  let g:colors_name="minimal2"
" }}}
" {{{ Italics
  let g:minimal2_terminal_italic = get(g:, 'minimal2_terminal_italic', 0)
  let s:italic = ""
  if g:minimal2_terminal_italic == 1
    let s:italic = "italic"
  endif
"}}}
" {{{ Bold
  let g:minimal2_terminal_bold = get(g:, 'minimal2_terminal_bold', 0)
  let s:bold = ""
  if g:minimal2_terminal_bold == 1
   let s:bold = "bold"
  endif
"}}}
" {{{ Colors
  ...
  let s:red    = ['#afc1a1', '203']
  let s:orange = ['#9aa7c8', '209']
  let s:yellow = ['#58677a', '221']
  let s:green  = ['#93a0c6', '114']
  let s:cyan   = ['#b4c5db', '73']
  let s:blue   = ['#728495', '68']
  let s:purple = ['#727389', '176']
  let s:brown  = ['#648274', '137']
  let s:white  = ['#e1e1e1', '15']
